...
4. Do any additional commit and push it to GitHub to trigger GitHub Action. 
    - _It will create `.gh-pages` branch with the built application content (`/dist` folder)._    
...
5. Now select `.gh-pages` branch as for GitHub Pages in your repository Settings on GitHub.
